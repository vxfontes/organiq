...
class OQAppBar extends StatelessWidget implements PreferredSizeWidget {
  final String title;
            ...
            Column(
              ...
              children: [
                OQText(
                  title,
                  context: context,
                ).titulo.color(AppColors.surface).build(),
                OQText(subtitle!, context: context).label
...
class OQLightAppBar extends StatelessWidget implements PreferredSizeWidget {
  const OQLightAppBar({
    super.key,
    required this.title,
    this.onBack,
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      title: OQText(title, context: context).titulo.build(),
    );
  }
}
