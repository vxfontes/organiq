...
class OQAIPulseIndicator extends StatefulWidget {
  ...
  @override
  State<OQAIPulseIndicator> createState() => _OQAIPulseIndicatorState();
}

class _OQAIPulseIndicatorState extends State<OQAIPulseIndicator>
  ...
  @override
  void didUpdateWidget(covariant OQAIPulseIndicator oldWidget) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                AppColors.ai50,
                Color.lerp(AppColors.ai100, AppColors.ai50, _controller.value)!,
              ],
            ),
...
class _WaveIndicator extends StatelessWidget {
  const _WaveIndicator({required this.isAnimating, required this.animation});
...
class _WavePainter extends CustomPainter {
  _WavePainter({required this.progress, required this.isAnimating});
