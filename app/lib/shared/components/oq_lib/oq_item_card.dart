...
class OQItemCard extends StatelessWidget {
  const OQItemCard({
    super.key,
    required this.title,
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Expanded(
                child: Row(
                  children: [
                    OQIcon(typeIcon, color: typeColor, size: 18),
                    const SizedBox(width: 6),
                    OQTagChip(label: typeLabel, color: typeColor),
                    if (done) ...[
                      const SizedBox(width: 6),
                      OQTagChip(label: doneLabel, color: AppColors.success600),
                    ],
                  ],
                ),
              ),
          ...
          if (secondary != null && secondary!.trim().isNotEmpty) ...[
            ...
            OQText(secondary!, context: context).muted.maxLines(2).build(),
          ],
          const SizedBox(height: 10),
          Row(
            children: [
