...
class OQInboxItemCard extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: OQText(title, context: context).subtitulo.build(),
              ),
              OQChip(label: statusLabel, color: statusColor),
            ],
          ),
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: [for (final tag in tags) OQTagChip(label: tag)],
          ),
        ],
      ),
    );
