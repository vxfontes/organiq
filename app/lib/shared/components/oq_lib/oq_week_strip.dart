...
class OQWeekStrip extends StatefulWidget {
  const OQWeekStrip({
    super.key,
  ...
  @override
  State<OQWeekStrip> createState() => _OQWeekStripState();
}

class _OQWeekStripState extends State<OQWeekStrip> {
  ...
  @override
  void didUpdateWidget(covariant OQWeekStrip oldWidget) {
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      OQText(_weekdayLabels[day.weekday - 1], context: context)
                          .caption
                      ...
                      AnimatedContainer(
                        ...
                        child: OQText('${day.day}', context: context).label
