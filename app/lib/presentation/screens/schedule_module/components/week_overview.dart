...
class WeekOverview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final routines = controller.allRoutines.value.where((r) => r.isActive).toList();
    
    if (routines.isEmpty) {
      return const IBCard(
        child: IBEmptyState(
          title: 'Nenhuma rotina ativa',
          subtitle: 'Crie rotinas para visualizá-las aqui na visão geral semanal.',
        ...
        child: IntrinsicHeight(
          child: Row(
            ...
            children: List.generate(7, (index) {
              ...
              final dayRoutines = routines.where((r) => r.weekdays.contains(apiWeekday)).toList()
