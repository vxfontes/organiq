...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/context-rules": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Context rule payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/daily-summary": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Daily summary token",
                        "name": "token",
                        "in": "query",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ListRoutinesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.RoutineTodaySummaryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/dto.CompleteRoutineRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.RoutineCompletionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateRoutineExceptionRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.RoutineExceptionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.RoutineStreakResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ToggleRoutineRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AcceptSuggestionBlockRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.AcceptSuggestionBlockResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SendSuggestionMessageRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuggestionMessageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ListSuggestionConversationsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/suggestions/conversations/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuggestionConversationDetailResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.AcceptSuggestionBlockRequest": {
            "type": "object",
            "properties": {
                "endsAt": {
                    "type": "string"
        ...
        "dto.AcceptSuggestionBlockResponse": {
            "type": "object",
            "properties": {
                "entityId": {
                    "type": "string"
        ...
        "dto.CreateRoutineExceptionRequest": {
            "type": "object",
            "properties": {
                "action": {
                    "type": "string"
        ...
        "dto.ListSuggestionConversationsResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.SuggestionConversationResponse"
                    }
                },
                "nextCursor": {
                    "type": "string"
        ...
        "dto.RoutineTodaySummaryResponse": {
            "type": "object",
            "properties": {
                "completed": {
                    "type": "integer"
        ...
        "dto.SendSuggestionMessageRequest": {
            "type": "object",
            "properties": {
                "conversationId": {
                    "type": "string"
        ...
        "dto.SuggestionConversationDetailResponse": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
                ...
                "messages": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.SuggestionConversationMessage"
                    }
                },
                "updatedAt": {
                    "type": "string"
        ...
        "dto.SuggestionConversationMessage": {
            "type": "object",
            "properties": {
                "blocks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.SuggestionBlock"
                    }
                },
                "content": {
                    "type": "string"
        ...
        "dto.SuggestionConversationResponse": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
